...
class ChatStatsController extends Controller
{
    public function index(Request $request)
    {
        ...
        // ponytail: DB down → empty stats, not a 500.
        try {
            ...
            return response()->json([
                'total_queries' => 0, 'successful' => 0, 'rejected' => 0,
                'no_context' => 0, 'rate_limited' => 0, 'topic_rejected' => 0,
                'today' => 0, 'daily_breakdown' => [], 'top_ips' => [],
            ]);
        }
    }
}
