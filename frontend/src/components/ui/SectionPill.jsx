...
const SectionPill = ({ label, caption }) => (
  <div className="inline-flex items-center gap-2.5 border border-theme rounded-full bg-theme-secondary p-1 text-sm text-theme-primary">
    <div className="inline-flex items-center bg-theme-card border border-theme rounded-2xl px-3 py-1">
      <span className="text-xs font-semibold uppercase tracking-wider leading-none">{label}</span>
    </div>
    <p className="pr-3 text-xs text-theme-muted leading-none">{caption}</p>
  </div>
)
