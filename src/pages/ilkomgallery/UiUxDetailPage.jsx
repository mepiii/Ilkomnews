          ...
          <div className="space-y-6">
            <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h4 className="text-white font-semibold text-lg">{design.creator}</h4>
                  <p className="text-gray-400 text-sm">{design.jurusan}</p>
                  <p className="text-gray-500 text-xs">NIM: {design.nim}</p>
                </div>
              </div>
