  ...
  return (
    ...
    >
      ...
      <div className="relative h-full flex flex-col justify-end p-5">
        {/* Category Badge */}
        <div className="mb-2">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-blue-600/90 backdrop-blur-sm text-white text-xs font-medium rounded-full">
            <Globe size={12} />
        ...
        {/* Title */}
        <h3 className="text-white text-xl font-bold mb-1 line-clamp-1 group-hover:text-blue-300 transition-colors">
          {project.title}
        </h3>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-500 via-cyan-500 to-blue-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
    </Link>
  )
}
