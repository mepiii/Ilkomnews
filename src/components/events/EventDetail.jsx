      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">{event.description || event.summary}</p>
          </div>
          ...
          <div className="mb-8 p-6 bg-bg-light rounded-lg">
            ...
            <ul className="space-y-2">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-gray-700">Mahasiswa aktif Ilmu Komputer</span>
              </li>
              <li className="flex items-start space-x-2">
                <CheckCircle size={18} className="text-green-500 mt-0.5" />
                <span className="text-gray-700">Membawa laptop (untuk sesi workshop)</span>
              </li>
              <li className="flex items-start space-x-2">
                <CheckCircle size={18} className="text-green-500 mt-0.5" />
                <span className="text-gray-700">Mengisi formulir pendaftaran</span>
              </li>
              <li className="flex items-start space-x-2">
                <CheckCircle size={18} className="text-green-500 mt-0.5" />
                <span className="text-gray-700">Membayar biaya pendaftaran (jika ada)</span>
              </li>
            </ul>
          </div>
          ...
          <div className="pt-6 border-t border-gray-200">
            {isEventPast ? (
              <div className="bg-gray-100 rounded-lg p-4 text-center">
                ...
                <p className="text-gray-600">Event ini telah selesai</p>
              </div>
            ) : isEventFull ? (
